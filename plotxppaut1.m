function h=plotxppaut1(arg1,options)
...
x=nan(size(data,1),4);
y=nan(size(data,1),4);
ymin=nan(size(data,1),2);
ymax=nan(size(data,1),2);
...
x(type1ix,1)=data(type1ix,1);
x(type2ix,2)=data(type2ix,1);
x(type3ix,3)=data(type3ix,1);
x(type4ix,4)=data(type4ix,1);

y(type1ix,1)=data(type1ix,2);
y(type2ix,2)=data(type2ix,2);
ymin(type3ix,1)=data(type3ix,2);
ymax(type3ix,1)=data(type3ix,3);
ymin(type4ix,2)=data(type4ix,2);
ymax(type4ix,2)=data(type4ix,3);
